    ...
    <table border="1">
        ...
        ?>
                <tr>
                    ...
                    <td>
                    <a href="../controller/postCheck.php?comment_id=<?php echo $comment['comment_id']; ?>&action=delete_comment">Delete Comment</a>
                    </td>
                </tr>
        <?php
            }
        ...
        <tr>
            <td colspan="2">
                <form action="../controller/postCheck.php" method="POST">
